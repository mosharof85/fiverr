            ...
            <div class="row">
                <div class="nav w-100 h-25">
                    <ul>
                        ...
                        <li><a href="#"><img src="{{env('APP_URL')}}/images/messages.png" alt=""><span>Messages</span></a></li>
                        ...
                        <div class="box-container">
                                                        ...
                                                        <div class="orderContainer">
                                                            <div class="orderbox-content">
                                                                ...
                                                                <div class="part3">
                                                                    ...
                                                                    <div><span>Discount:</span><p class="bold discount-amt">AU$ 00.00<span class="aus"></p></div>
                                                                    <div><span>GST:</span><p class = "bold gst-amt">AU$ 00.00<span class="aus"></p></div>
                                                                </div>
                                                            </div>
                                                            <div class="orderbox-footer">
                                                                <span>Total:</span>
                                                                <input type="hidden" value="" name="price" class="bold total total-amt"><h4 class="bold total total-amt" style="font-weight:700">AU$ 00.00</h5>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        @foreach ($messages as $message)
                                            <div href="#" class="list-group-item list-group-item-action mt-1">
                                                <div class="d-flex w-100 justify-content-between">
                                                    <span class="badge badge-primary badge-pill align-self-center" style="font-size: 1.125rem !important;" >{{$message->title}}</span>
                                                    <span class="badge badge-primary badge-pill align-self-center">{{$message->created_at->format('Y-m-d')}}</span>
                                                </div>
                                                <p class="mb-1 lead"><i>"{{$message->body}}"<i></p>
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                            ...
                            <div class="option s__services">
                                ...
                                <div class="services-btns">
                                    <!-- <a href="./order-deliver.html" class="btn-1 f-montserrat">Delivery</a> -->
                                    <a href="{{url("client-portal")}}" class="btn-2 f-montserrat">View Invoice</a>
                                </div>
                                <div class="my-order overflow-controller">
                                    <div class="services overflow-holder">
                                        @foreach ($invoices as $invoice)
                                            <div class="dropshipping-package border-bottom mb-1">
                                                <div class="title">{{$invoice->type}}</div>
                                                <div class="grid">
                                                    <div>Invoice: #{{$invoice->id}}</div>
                                                    <div>Price: ${{$invoice->price}}</div>
                                                    <div>Date due:{{$invoice->due_date}}</div>
                                                    ...
                                                    <a href="/order-details/{{$invoice->id}}"><button class="btn btn-primary">View More</button></a>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
