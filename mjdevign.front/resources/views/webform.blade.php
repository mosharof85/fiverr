    ...
    <div class="col1">
        <div class="colTop">
            <div class="logo-image_1">
                <img src={{"/images/web-development.png"}} alt="drop" style="width: 107px; height: 101px; object-fit: cover;">
                <div class="form-info">
                ...
                <div class="bodyContainer">
                    ...
                    <div class="step3 bg-gray">
                        ...
                        <!-- <form action="" class="form"> -->
                            ...
                            <!-- dropdown page 2 -->
                            <div class="dropdown-view bors border-top">
                                <!-- start dropdown -->
                    ...
                    <div class="nextBtn hasPadding">
                        ...
                        @guest
                            ...
                            <a class="btn_checkout">
                                <button class="button" id="loginModalBtn">
                                    Checkout
                                </button>
                            </a>
