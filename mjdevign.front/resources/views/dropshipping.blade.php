...
@section('content')
<!-- content section -->
<!-- <span id="package_stat_Product Title & Description Editing">Add To Package</span> -->
    ...
    <div class="col1">
        <div class="colTop">
            <div class="logo-image_1">
                <img src={{"/images/shipping.png"}} alt="drop" style="width: 107px; height: 101px; object-fit: cover;">
                <div class="form-info">
                    ...
                    <div class="activeBody stores">
                        ...
                        <div class="form">
                            ...
                            <textarea name="storeDescription" rows="3"
                                        placeholder="Share a brief descrition of your tor"></textarea>
                            <p class="bold">
                                Additional notes:
                            </p>
                            ...
                            <input class="browse image" name="image" type="file" files=true accept="image/*"/>
                            </p>
                        </div>
                    </div>
                    <p class="divider"></p>
                ...
                <div class="orderContainer">
                    ...
                    <div class="orderBody">
                        ...
                        <div class="s_betweens mid">
                                <div>
                                <p>
                                        <img src="/images/coupn.png" alt="step1" class="enter"><input style="border: none; padding: 15px 10px" name="promo" type="text" placeholder="Enter a promo code." oninput="order.promoCodeOnChange(this)">
