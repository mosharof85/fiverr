            ...
            <div class="w-100 d-none" id="reg_new" style="margin-left: 25px">
                <div class="iBtn">
                    <div
                        ...
                        <input type="text" name="newDomainName" value="www." placeholder="www.">
                    </div>
                </div>
                <p class="my_sitecom" style="margin-right: 2%; font-size: 15px">
                    <small></small>Click <a href="https://instantdomainsearch.com/" target="_blank">here</a> to check your domain name is
