                        ...
                        <div class="option s__services default">
                            ...
                            <div class="services">
                                ...
                                <div class="title">Upload:</div>
                                    ...
                                    @if(strchr($uploadimage[$i],'JPG') ||strchr($uploadimage[$i],'PNG') ||strchr($uploadimage[$i],'GIF')) 
                                        
                                            <div class="content">
                                                <img class="content-img" src = {{url("/images/uploads/".$uploadimage[$i])}}>
                                            </div>
                                    @else
                                        <div class="content">
                                        <a class="content-img" href = {{url("admin/download/".$invoice->id)}}>Click here to download.</a>
                                        </div>
                                    @endif
                                    @endif
                                    @endfor
                ...
                <div class="box-container">
                    <div class="option s__services default">
                        ...
                        <div class="services">
                            ...
                            <div class="upload">
                                <div class="title">Upload:</div>
                                @if ($dropshippingdetail->image)
                                <div class="store-info">
                                    <div class="content">
                                                <img class="content-img" src = {{url("/images/uploads/".$dropshippingdetail->image)}}>
                                            </div>
                                </div>
                                @endif
                            </div>
